...
if __name__ == '__main__':
    ...
    logger.info("vocab shape: {}".format(np.shape(vectorizer_tfidf.vocabulary_.keys())))
    ...
    for column in columns[2:]:
        ...
        logger.info("start train {} model".format(column))
        text_classifier.fit(content_train, label_train)
        logger.info("complete train {} model".format(column))
